...
public class FileWriterDemo {
    ...
    public static void main(String[] args) {
        ...
        fileWriterMethod("data/fileWriter.txt", "Hello World!");
        bufferWriterMethod("data/bufferWriter.txt", "Hello World!");
        printWriterMethod("data/printWriter.txt", "Hello World!");
        fileOutputStreamMethod("data/fileOutputStream.txt", "Hello World!");
        bufferOutputStreamMethod("data/bufferOutputStreamMethod.txt", "Hello World!");
        filesTest("data/filesTest.txt", "Hello World!");
    }
